...
# Makes sure that the column names or the data structure is consistent and good to go.
...
# Makes sure the column values are good to go
...
if __name__ == "__main__":
    ...
    # Creating and storing my plots
    create_exploration_plots(df)

    # Storing my null values to csv
